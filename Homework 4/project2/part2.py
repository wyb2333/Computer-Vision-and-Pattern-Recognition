...
################################################################################
# conv_w1 = torch.rand((channel_1, 3, 5, 5), device=device, dtype=dtype, requires_grad=True)
# conv_b1 = torch.zeros((channel_1, ), device=device, dtype=dtype, requires_grad=True)
# conv_w2 = torch.rand((channel_2, channel_1, 3, 3), device=device, dtype=dtype, requires_grad=True)
# conv_b2 = torch.zeros((channel_2, ), device=device, dtype=dtype, requires_grad=True)
# fc_w = torch.rand((channel_2*32*32, 10), device=device, dtype=dtype, requires_grad=True)
