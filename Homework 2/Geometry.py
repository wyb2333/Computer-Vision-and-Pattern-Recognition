...
cv2.imshow("平移", trans(img_zero, matrix_trans[0]).astype("uint8"))
cv2.imshow("缩放", trans(img_zero, matrix_trans[1]).astype("uint8"))
cv2.imshow("旋转", trans(img_zero, matrix_trans[2], shift=True).astype("uint8"))
cv2.imshow("相似", trans(img_zero, matrix_trans[2] @ matrix_trans[0] @ matrix_trans[1], shift=True).astype("uint8"))
cv2.imshow("仿射", trans(img_zero, matrix_trans[3], shift=True).astype("uint8"))
cv2.imshow("投影", trans(img_zero, matrix_trans[4]).astype("uint8"))
cv2.waitKey(0)
